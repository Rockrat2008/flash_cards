...
card_1 = Card.new("Who is the lead actress in Pretty Woman?", "Julia Roberts", :Hollywood)
card_2 = Card.new("What is the 3rd planet?", "Earth", :STEM)
card_3 = Card.new("Who is the lead actor from Pretty Woman?", "Richard Gere", :Hollywood)
